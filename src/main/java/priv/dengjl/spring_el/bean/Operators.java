...
public class Operators {
	...
	public String toString() {
		return "Operators [testEqual=" + testEqual + ", testNotEqual=" + testNotEqual + ", testLessThan=" + testLessThan
				...
				+ testExponentialPower + ", threeOperator=" + threeOperator + "]";
	}

	public boolean isThreeOperator() {
		return threeOperator;
	}

	public void setThreeOperator(boolean threeOperator) {
